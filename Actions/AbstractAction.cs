...
{
    public abstract class AbstractAction<TMessageRequest, TMessageResponse, TParams> where TMessageRequest : INetworkRequest where TParams : IActionParams where TMessageResponse : INetworkResponse, new()
    {
